...
async function main() {
    ...
    const favoriteLanguage = await prisma.survey.upsert({
        ...
        update: {},
        create: { question: 'What is your favorite programming language?', answers: {
            create: [{
                answer: 'TypeScript',
            },
            {
    ...
    const favoriteColor = await prisma.survey.upsert({
        ...
        update: {},
        create: { question: 'What is your favorite color?', answers: {
            create: [{
                answer: 'Ultraviolet',
            },
            { 
    ...
    const favoriteDirection = await prisma.survey.upsert({
        ...
        update: {},
        create: { question: 'What is your favorite direction?', answers: {
            create: [{
                answer: 'North',
            },
            {
